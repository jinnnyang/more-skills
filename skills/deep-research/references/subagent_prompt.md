...
- !["[Highly descriptive alt explaining chart layout, axes, data points, or diagram structure to downstream LLMs]"]({original_web_image_url} "{Image Title}")
- ... (Include high-value diagrams, charts, or maps. Leave empty if none found.)
