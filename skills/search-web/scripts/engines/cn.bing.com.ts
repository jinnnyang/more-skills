...
export class BingClient extends SimpleFakeBrowser {
   ...
   */
  public async search_videos_by_texts(query: string): Promise<SearchResult[]> {
   ...
   */
  public async search_papers_by_texts(query: string): Promise<SearchResult[]> {
   ...
   */
  public async search_locations_by_texts(query: string): Promise<SearchResult[]> {
   ...
   */
  public async search_terms_by_texts(query: string): Promise<SearchResult[]> {
   ...
   */
  public async search_images_by_images(imagePathOrUrl: string): Promise<SearchResult[]> {
   ...
   */
  public async search_pages_by_images(imagePathOrUrl: string): Promise<SearchResult[]> {
    const html = await this.fetch_visual_search_html(imagePathOrUrl);
    const results: SearchResult[] = [];
    const imgExtensions = /\.(jpg|jpeg|png|webp|gif|svg|bmp)(\?|$)/i;
   ...
   */
  private async fetch_visual_search_html(imagePathOrUrl: string): Promise<string> {
    let targetUrl = '';
